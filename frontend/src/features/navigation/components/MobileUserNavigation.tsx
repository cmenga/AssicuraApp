    ...
    <div className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 px-4 py-3 z-50">
      <div className="grid grid-cols-2 gap-2">
        <button
          ...
          className={`flex flex-col items-center gap-1 py-2 rounded-lg transition ${activeTab === "overview"
        ...
        <button
          ...
          className={`flex flex-col items-center gap-1 py-2 rounded-lg transition ${activeTab === "policies"
              ? "text-blue-600 bg-blue-50"
              : "text-gray-600"
            }`}
        >
