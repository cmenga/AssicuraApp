...
const benefits = [
    {
        ...
        description: "Nessun costo nascosto. Preventivi chiari e convenienti in pochi secondi."
    },
    {
        icon: <Clock className="w-8 h-8" />,
        title: "Attivazione Immediata",
        description: "La tua polizza è attiva subito dopo l'acquisto, 24 ore su 24."
    },
    {
    ...
    },
    {
        ...
        description: "Supporto clienti sempre disponibile via chat, email o telefono."
    }
];
