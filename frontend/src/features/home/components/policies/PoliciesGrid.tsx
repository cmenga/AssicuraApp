...
import { AlertCircle, Bike, Car, Download, Eye, MoreVertical } from "lucide-react";
            ...
            {policies.map((policy) => {
                ...
                return (
                    ...
                    >
                        ...
                        <div
                            className={`inline-block px-3 py-1 rounded-full text-xs font-medium mb-4 ${getStatusColor(policy.stato as ColorsState)}`}
                        >
                            {policy.stato}
                        </div>
