...
export function HeroSectionWithQuoteForm() {
    ...
    return (<section className="pt-24 pb-12 px-4 sm:px-6 lg:px-8 bg-linear-to-br from-blue-600 via-blue-500 to-cyan-400">
                            ...
                            <div className="grid grid-cols-3 gap-3">
                                {vehicles.map((vehicle) => (
                                    <button
                                        ...
                                        className={`p-4 rounded-xl border-2 transition flex flex-col items-center gap-2 ${selectedVehicle === vehicle.id
