...
import { 
  ...
  Edit, Save, X, Camera, Shield, CheckCircle, AlertCircle, Home
} from 'lucide-react';
        ...
        <div className="bg-linear-to-r from-blue-600 to-cyan-500 rounded-3xl p-8 mb-8 text-white">
          <div className="flex flex-col md:flex-row items-center gap-6">
            ...
            <div className="text-center md:text-left">
              <h2 className="text-4xl font-bold mb-2">{userData.nome} {userData.cognome}</h2>
              <p className="text-lg opacity-90 mb-1">{userData.email}</p>
              <p className="opacity-90">{userData.telefono}</p>
            </div>
          </div>
        </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-gray-900 font-medium py-3">{userData.nome}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-gray-900 font-medium py-3">{userData.cognome}</p>
                  )}
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Codice Fiscale</label>
                  <p className="text-gray-900 font-medium py-3 bg-gray-50 px-4 rounded-xl">{userData.codiceFiscale}</p>
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium py-3 bg-gray-50 px-4 rounded-xl">
                    {new Date(userData.dataNascita).toLocaleDateString('it-IT')}
                  </p>
                  <p className="text-xs text-gray-500 mt-1">Non modificabile</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-gray-900 font-medium py-3 bg-gray-50 px-4 rounded-xl">{userData.luogoNascita}</p>
                </div>

                <div>
                  <label className="block text-sm font-medium text-gray-700 mb-2">Sesso</label>
                  <p className="text-gray-900 font-medium py-3 bg-gray-50 px-4 rounded-xl">
                    {userData.sesso === 'M' ? 'Maschio' : 'Femmina'}
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-gray-900 font-medium py-3">{userData.email}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-gray-900 font-medium py-3">{userData.telefono}</p>
                  )}
                </div>
              </div>
            </div>
              ...
              <div className="grid md:grid-cols-2 gap-6">
                <div className="md:col-span-2">
                  ...
                  {editMode ? (
                    ...
                    <p className="text-gray-900 font-medium py-3">{userData.indirizzo}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-gray-900 font-medium py-3">{userData.cap}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-gray-900 font-medium py-3">{userData.citta}</p>
                  )}
                </div>
                ...
                <div>
                  ...
                  {editMode ? (
                    ...
                    <p className="text-gray-900 font-medium py-3">{userData.provincia}</p>
                  )}
                </div>
              </div>
            </div>
                    ...
                    <div className="flex items-start gap-4">
                      <div className={`p-4 rounded-xl ${
                        ...
                        <CreditCard className={`w-8 h-8 ${
                          patente.stato === 'Valida' ? 'text-green-600' : 'text-red-600'
                        }`} />
                      </div>
                      <div>
