...
export default function DriverLicenses({ dateOfBirth }: { dateOfBirth: string; }) {
  ...
  return (
    <div className="space-y-6">
      ...
      {!hasAllLicenses &&
        <div onClick={handleOpen} className="bg-white rounded-2xl shadow-md p-8 text-center border-2 border-dashed border-gray-300 hover:border-blue-500 transition cursor-pointer">
          ...
          <button onClick={handleOpen} className="cursor-pointer bg-blue-600 text-white px-6 py-2 rounded-xl font-semibold hover:bg-blue-700 transition">
            Aggiungi Patente
          </button>
        </div>
      }
